...
public class CargoTruck_CC_SettingsEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (foldControllerSettings) {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.PropertyField(serializedObject.FindProperty("contactParticles"), new GUIContent("Contact Particles On Collisions"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("scratchParticles"), new GUIContent("Scratch Particles On Collisions"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("wheelDeflateParticles"), new GUIContent("Wheel Deflate Particles"));
